...
export const MOBILE_LAYOUT_GROUPS = [
  {
    key: 'homeSections',
    title: 'Home',
    description: 'Sections for ClaudyGod Music, Nuggets of Truth, Worship Hour, Teens, Kids, and Speaks.',
  ...
  },
  {
    key: 'videoSections',
    title: 'Videos',
    description: 'Video sections for Worship Hour, Teens, Kids, and Speaks.',
  ...
  },
  {
    key: 'playerSections',
    title: 'Music',
    description: 'Audio sections for ClaudyGod Music, Nuggets of Truth, and Worship Hour.',
  ...
  },
  {
    key: 'librarySections',
    title: 'Library',
    description: 'Saved collections for ClaudyGod Music, Speaks, and Kids.',
    defaultActionLabel: 'Open',
