...
export default function SignUpScreen() {
  ...
  return (
    <AuthScreenFrame backPath={APP_ROUTES.landing} salutation="Create your space" description="Save favorites, follow live sessions, and continue your worship experience across devices." title="Create account" subtitle="Enter your details, then confirm your email.">
      <View style={{ gap: 12 }}>
      ...
      <AppButton title="Create account" size="lg" fullWidth loading={submitting} loadingLabel="Creating account" loadingVariant="brand" onPress={() => void handleSignUp()} disabled={!canSubmit || submitting} style={{ marginTop: 16 }} />
