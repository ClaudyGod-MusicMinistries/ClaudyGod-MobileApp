...
export const layout = {
  ...
  tabBarHeight:          66,
  tabBarCompactHeight:   62,
  tabBarMaxWidth:        680,
  tabBarActionSize:      54,
  tabBarActionCompactSize: 50,
  tabBarActionRingWidth: 5,
  tabBarActionLift:      18,
  tabBarActionActiveLift: 2,
  tabBarPlayIconOpticalOffset: 1.5,
  tabBarContentPadding:  112,
};
