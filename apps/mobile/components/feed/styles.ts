...
export const useFeedStyles = makeStyles((theme) => ({
  ...
  heroMetaText:      { color: theme.colors.mediaTextSubtle, fontSize: 11, marginTop: 5, letterSpacing: 0.2 },
  heroSubtitle:      { color: theme.colors.mediaTextMuted, marginTop: 6, maxWidth: 520, lineHeight: 20 },
  ...
  liveBadge: {
    ...
    borderRadius: theme.radius.pill, backgroundColor: theme.colors.liveSurface,
    paddingHorizontal: 9, paddingVertical: 4,
    flexDirection: 'row', alignItems: 'center', gap: 5,
    shadowColor: theme.colors.danger, shadowOpacity: 0.4, shadowRadius: 6, shadowOffset: { width: 0, height: 2 },
  },
  liveBadgeDot:    { width: 6, height: 6, borderRadius: 3, backgroundColor: theme.colors.mediaText },
  liveBadgeText:   { color: theme.colors.mediaText, fontSize: 10, fontWeight: '700', letterSpacing: 0.5 },
  durationPill: {
    position: 'absolute', right: 10, bottom: 10,
    borderRadius: theme.radius.pill, backgroundColor: theme.colors.mediaControl,
    paddingHorizontal: 8, paddingVertical: 3,
    borderWidth: 1, borderColor: theme.colors.mediaBorder,
  },
  durationText:    { color: theme.colors.mediaText, fontSize: 10, fontWeight: '600' },
  ...
  listDuration: {
    ...
    backgroundColor: theme.colors.mediaControl, paddingHorizontal: 5, paddingVertical: 2,
  },
  listDurationText:  { color: theme.colors.mediaText, fontSize: 9 },
